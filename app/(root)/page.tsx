  ...
  return (
    <>
      ...
      <Container className="flex h-screen">
        ...
        />
        <div className="absolute inset-0 z-10 bg-gradient-to-r from-orange-200 to-transparent opacity-20"></div>
        <div className="z-20 flex w-full items-end">
          <div className="mb-8 max-w-2xl sm:mb-16 bg-[#455A7C33] p-4 rounded-xl backdrop-blur">
            <p className="text-xl md:text-lg font-bold uppercase tracking-widest text-white drop-shadow-[0_0_1px_rgb(100,100,100)] drop-shadow-[0_0_3px_rgba(0,0,0,0.5)]"
            >
              Get Kindr: Easy, Fun, and REWARDING!
            </p>
            <h1 className="py-1 pb-4 md:pb-6 text-xl font-bold text-white drop-shadow-[0_0_1px_rgb(100,100,100)] drop-shadow-[0_0_3px_rgba(0,0,0,0.5)]"

            >
              Make an impact with a <a className="underline" href="#faq">Voluntary Act of Kindness</a> or by joining short-term volunteer events. Connect with inspiring people and earn rewards while helping others..
            </h1>
            ...
            <div className="flex flex-col items-start space-y-3 sm:flex-row sm:items-center sm:space-x-4 sm:space-y-0">
              ...
              <a
                ...
                className="text-white btn-outline rounded-2xl px-8 py-4 text-center text-sm font-semibold uppercase tracking-widest"
                style={{ background: "#8091a8" }}
              >
      ...
      <Container className="mt-10 flex flex-wrap items-center !p-0">
        <div className="lg:w-1/2">
          {/* <p className="text-md align-items text-gray-500">About Us</p> */}
          <SectionTitle
