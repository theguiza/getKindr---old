    ...
    const user = await prisma.user.create({
      data: {
        ...
        organization: isOrganization
          ...
          : undefined,
        volunteer: isOrganization ? undefined : {
          create: {
            preferredName: "", 
            bio: "",
            location: "",
            ...
            availability: {
              create: [
                { dayOfWeek: "sunday", morningAvailable: false, eveningAvailable: false },
                { dayOfWeek: "monday", morningAvailable: false, eveningAvailable: false },
                { dayOfWeek: "tuesday", morningAvailable: false, eveningAvailable: false },
                { dayOfWeek: "wednesday", morningAvailable: false, eveningAvailable: false },
                { dayOfWeek: "thursday", morningAvailable: false, eveningAvailable: false },
                { dayOfWeek: "friday", morningAvailable: false, eveningAvailable: false },
                { dayOfWeek: "saturday", morningAvailable: false, eveningAvailable: false },
                { dayOfWeek: "sunday", morningAvailable: false, eveningAvailable: false },
                { dayOfWeek: "monday", morningAvailable: false, eveningAvailable: false },
                { dayOfWeek: "tuesday", morningAvailable: false, eveningAvailable: false },
                { dayOfWeek: "wednesday", morningAvailable: false, eveningAvailable: false },
